...
import {
  Anchor, Badge, Button, Card, Center, Grid, Group, Modal, Skeleton, Stack, Text, TextInput,
  Title, Tooltip,
} from '@mantine/core';
import { notifications } from '@mantine/notifications';
import {
  IconArrowLeft, IconCheck, IconEye, IconEyeOff, IconLock, IconPencil, IconUserOff,
} from '@tabler/icons-react';
import { getEmployee, terminateEmployee, type EmployeeDetail } from '../api/employees';
import {
